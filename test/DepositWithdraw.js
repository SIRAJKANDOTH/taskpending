...
contract(" Deposit", function (accounts) {
	...
	it("should add safe to APS", async () => {
		...
		console.log("yrt address", yrtToken.address);

		let investor2YrtBalance = await yrtToken.balanceOf(accounts[2]);
		console.log(
			"Investor 2 before withdrawal",
