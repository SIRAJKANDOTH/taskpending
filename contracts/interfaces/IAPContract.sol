...
interface IAPContract{
    ...
    function addVault(address, address, uint256[] calldata) external;
    ...
    function getStrategyManagementDetails(address, address) external view returns(address, uint256);
